function XDimaClient(requestURL, activeRequestLimit) {
	"use strict";
    ...
    function findRequestURL(requestURL) {
        if (!requestURL || typeof requestURL !== "string") {
            return findBaseURL() + "rs/XDima/";
        } else if(requestURL.startsWith("http")) {
            return requestURL;
        } else {
            return findBaseURL() + "rs/XDima/" + requestURL + "/";
        }
    }
	 ...
	 */
	this.createDistanceMatrix = function (createDistanceMatrixRequest , handler, timeout) {
		return sendRequest("createDistanceMatrix", createDistanceMatrixRequest, handler, timeout || this.createDistanceMatrix.timeout);
	};
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.startCreateDistanceMatrix = function (createDistanceMatrixRequest , handler, timeout) {
		return sendRequest("startCreateDistanceMatrix", createDistanceMatrixRequest, handler, timeout || this.startCreateDistanceMatrix.timeout);
	};
	 ...
	 */
	this.runCreateDistanceMatrix = function (createDistanceMatrixRequest , handler, watchRequest, onUpdate, retryOptions) {
		return runJob(client.startCreateDistanceMatrix, createDistanceMatrixRequest, client.fetchDistanceMatrixResponse, handler, watchRequest, onUpdate, retryOptions);
	};	
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.listDistanceMatrices = function (listDistanceMatricesRequest , handler, timeout) {
		return sendRequest("listDistanceMatrices", listDistanceMatricesRequest, handler, timeout || this.listDistanceMatrices.timeout);
	};
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.queryMatrixElements = function (queryMatrixElementsRequest , handler, timeout) {
		return sendRequest("queryMatrixElements", queryMatrixElementsRequest, handler, timeout || this.queryMatrixElements.timeout);
	};
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.changeDistanceMatrix = function (changeDistanceMatrixRequest , handler, timeout) {
		return sendRequest("changeDistanceMatrix", changeDistanceMatrixRequest, handler, timeout || this.changeDistanceMatrix.timeout);
	};
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.startChangeDistanceMatrix = function (changeDistanceMatrixRequest , handler, timeout) {
		return sendRequest("startChangeDistanceMatrix", changeDistanceMatrixRequest, handler, timeout || this.startChangeDistanceMatrix.timeout);
	};
	 ...
	 * @returns {object} the XMLHttpRequest object used, or null if the active request limit has been reached. 
	 */
	this.runChangeDistanceMatrix = function (changeDistanceMatrixRequest , handler, watchRequest, onUpdate, retryOptions) {
		return runJob(client.startChangeDistanceMatrix, changeDistanceMatrixRequest, client.fetchDistanceMatrixResponse, handler, watchRequest, onUpdate, retryOptions);
	};	
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.deleteDistanceMatrix = function (deleteDistanceMatrixRequest , handler, timeout) {
		return sendRequest("deleteDistanceMatrix", deleteDistanceMatrixRequest, handler, timeout || this.deleteDistanceMatrix.timeout);
	};
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.fetchDistanceMatrixResponse = function (id, onResult, timeout) {
		return sendRequest("fetchDistanceMatrixResponse", { id: id }, onResult, timeout || client.fetchDistanceMatrixResponse.timeout);
	};
