function XMapClient(requestURL, activeRequestLimit) {
	"use strict";
    ...
    function findRequestURL(requestURL) {
        if (!requestURL || typeof requestURL !== "string") {
            return findBaseURL() + "rs/XMap/";
        } else if(requestURL.startsWith("http")) {
            return requestURL;
        } else {
            return findBaseURL() + "rs/XMap/" + requestURL + "/";
        }
    }
	 ...
	 */
	this.renderMap = function (mapRequest , handler, timeout) {
		return sendRequest("renderMap", mapRequest, handler, timeout || this.renderMap.timeout);
	};
