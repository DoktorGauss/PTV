function XClusterClient(requestURL, activeRequestLimit) {
	"use strict";
    ...
    function findRequestURL(requestURL) {
        if (!requestURL || typeof requestURL !== "string") {
            return findBaseURL() + "rs/XCluster/";
        } else if(requestURL.startsWith("http")) {
            return requestURL;
        } else {
            return findBaseURL() + "rs/XCluster/" + requestURL + "/";
        }
    }
	 ...
	 */
	this.planClusters = function (planClustersRequest , handler, timeout) {
		return sendRequest("planClusters", planClustersRequest, handler, timeout || this.planClusters.timeout);
	};
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.startPlanClusters = function (planClustersRequest , handler, timeout) {
		return sendRequest("startPlanClusters", planClustersRequest, handler, timeout || this.startPlanClusters.timeout);
	};
	 ...
	 * @param {object} [watchRequest] - options passed to watchJob calls; define progressUpdatePeriod to activate regular progress reports.
	 ...
	 */
	this.runPlanClusters = function (planClustersRequest , handler, watchRequest, onUpdate, retryOptions) {
		return runJob(client.startPlanClusters, planClustersRequest, client.fetchClustersResponse, handler, watchRequest, onUpdate, retryOptions);
	};	
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.coverLocations = function (coverLocationsRequest , handler, timeout) {
		return sendRequest("coverLocations", coverLocationsRequest, handler, timeout || this.coverLocations.timeout);
	};
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.startCoverLocations = function (coverLocationsRequest , handler, timeout) {
		return sendRequest("startCoverLocations", coverLocationsRequest, handler, timeout || this.startCoverLocations.timeout);
	};
	 ...
	 * @returns {object} the XMLHttpRequest object used, or null if the active request limit has been reached. 
	 */
	this.runCoverLocations = function (coverLocationsRequest , handler, watchRequest, onUpdate, retryOptions) {
		return runJob(client.startCoverLocations, coverLocationsRequest, client.fetchClustersResponse, handler, watchRequest, onUpdate, retryOptions);
	};	
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.planVisits = function (planVisitsRequest , handler, timeout) {
		return sendRequest("planVisits", planVisitsRequest, handler, timeout || this.planVisits.timeout);
	};
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.startPlanVisits = function (planVisitsRequest , handler, timeout) {
		return sendRequest("startPlanVisits", planVisitsRequest, handler, timeout || this.startPlanVisits.timeout);
	};
	 ...
	 * @returns {object} the XMLHttpRequest object used, or null if the active request limit has been reached. 
	 */
	this.runPlanVisits = function (planVisitsRequest , handler, watchRequest, onUpdate, retryOptions) {
		return runJob(client.startPlanVisits, planVisitsRequest, client.fetchVisitsResponse, handler, watchRequest, onUpdate, retryOptions);
	};	
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.optimizeVisitSequence = function (optimizeVisitSequenceRequest , handler, timeout) {
		return sendRequest("optimizeVisitSequence", optimizeVisitSequenceRequest, handler, timeout || this.optimizeVisitSequence.timeout);
	};
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.startOptimizeVisitSequence = function (optimizeVisitSequenceRequest , handler, timeout) {
		return sendRequest("startOptimizeVisitSequence", optimizeVisitSequenceRequest, handler, timeout || this.startOptimizeVisitSequence.timeout);
	};
	 ...
	 * @returns {object} the XMLHttpRequest object used, or null if the active request limit has been reached. 
	 */
	this.runOptimizeVisitSequence = function (optimizeVisitSequenceRequest , handler, watchRequest, onUpdate, retryOptions) {
		return runJob(client.startOptimizeVisitSequence, optimizeVisitSequenceRequest, client.fetchVisitSequenceResponse, handler, watchRequest, onUpdate, retryOptions);
	};	
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.fetchVisitsResponse = function (id, onResult, timeout) {
		return sendRequest("fetchVisitsResponse", { id: id }, onResult, timeout || client.fetchVisitsResponse.timeout);
	};
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.fetchClustersResponse = function (id, onResult, timeout) {
		return sendRequest("fetchClustersResponse", { id: id }, onResult, timeout || client.fetchClustersResponse.timeout);
	};
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.fetchVisitSequenceResponse = function (id, onResult, timeout) {
		return sendRequest("fetchVisitSequenceResponse", { id: id }, onResult, timeout || client.fetchVisitSequenceResponse.timeout);
	};
