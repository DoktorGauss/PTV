function XRuntimeClient(requestURL, activeRequestLimit) {
	"use strict";
    ...
    function findRequestURL(requestURL) {
        if (!requestURL || typeof requestURL !== "string") {
            return findBaseURL() + "rs/XRuntime/";
        } else if(requestURL.startsWith("http")) {
            return requestURL;
        } else {
            return findBaseURL() + "rs/XRuntime/" + requestURL + "/";
        }
    }
	 ...
	 */
	this.getRuntimeInformation = function (runtimeInformationRequest , handler, timeout) {
		return sendRequest("getRuntimeInformation", runtimeInformationRequest, handler, timeout || this.getRuntimeInformation.timeout);
	};
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.getLicenseInformation = function (licenseInformationRequest , handler, timeout) {
		return sendRequest("getLicenseInformation", licenseInformationRequest, handler, timeout || this.getLicenseInformation.timeout);
	};
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.getDataInformation = function (dataInformationRequest , handler, timeout) {
		return sendRequest("getDataInformation", dataInformationRequest, handler, timeout || this.getDataInformation.timeout);
	};
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.getContentUpdateStatus = function (contentUpdateStatusRequest , handler, timeout) {
		return sendRequest("getContentUpdateStatus", contentUpdateStatusRequest, handler, timeout || this.getContentUpdateStatus.timeout);
	};
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.resetMetrics = function (resetMetricsRequest , handler, timeout) {
		return sendRequest("resetMetrics", resetMetricsRequest, handler, timeout || this.resetMetrics.timeout);
	};
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.shutdownServer = function (shutdownServerRequest , handler, timeout) {
		return sendRequest("shutdownServer", shutdownServerRequest, handler, timeout || this.shutdownServer.timeout);
	};
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.restartModules = function (restartModulesRequest , handler, timeout) {
		return sendRequest("restartModules", restartModulesRequest, handler, timeout || this.restartModules.timeout);
	};
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.stopRequest = function (stopDeleteRequest , handler, timeout) {
		return sendRequest("stopRequest", stopDeleteRequest, handler, timeout || this.stopRequest.timeout);
	};
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.deleteRequest = function (stopDeleteRequest , handler, timeout) {
		return sendRequest("deleteRequest", stopDeleteRequest, handler, timeout || this.deleteRequest.timeout);
	};
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.convert = function (conversionRequest , handler, timeout) {
		return sendRequest("convert", conversionRequest, handler, timeout || this.convert.timeout);
	};
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.createSupportPackage = function (supportPackageRequest , handler, timeout) {
		return sendRequest("createSupportPackage", supportPackageRequest, handler, timeout || this.createSupportPackage.timeout);
	};
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.getServerConfiguration = function (serverConfigurationRequest , handler, timeout) {
		return sendRequest("getServerConfiguration", serverConfigurationRequest, handler, timeout || this.getServerConfiguration.timeout);
	};
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.getConfigurationFile = function (configurationFileRequest , handler, timeout) {
		return sendRequest("getConfigurationFile", configurationFileRequest, handler, timeout || this.getConfigurationFile.timeout);
	};
