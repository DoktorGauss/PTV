function XDataClient(requestURL, activeRequestLimit) {
	"use strict";
    ...
    function findRequestURL(requestURL) {
        if (!requestURL || typeof requestURL !== "string") {
            return findBaseURL() + "rs/XData/";
        } else if(requestURL.startsWith("http")) {
            return requestURL;
        } else {
            return findBaseURL() + "rs/XData/" + requestURL + "/";
        }
    }
	 ...
	 */
	this.getTimeZone = function (timeZoneRequest , handler, timeout) {
		return sendRequest("getTimeZone", timeZoneRequest, handler, timeout || this.getTimeZone.timeout);
	};
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.startCreateHighPerformanceRoutingNetwork = function (createHighPerformanceRoutingNetworkRequest , handler, timeout) {
		return sendRequest("startCreateHighPerformanceRoutingNetwork", createHighPerformanceRoutingNetworkRequest, handler, timeout || this.startCreateHighPerformanceRoutingNetwork.timeout);
	};
	 ...
	 */
	this.runCreateHighPerformanceRoutingNetwork = function (createHighPerformanceRoutingNetworkRequest , handler, watchRequest, onUpdate, retryOptions) {
		return runJob(client.startCreateHighPerformanceRoutingNetwork, createHighPerformanceRoutingNetworkRequest, client.fetchHighPerformanceRoutingNetworkResponse, handler, watchRequest, onUpdate, retryOptions);
	};	
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.deleteHighPerformanceRoutingNetwork = function (deleteHighPerformanceRoutingNetworkRequest , handler, timeout) {
		return sendRequest("deleteHighPerformanceRoutingNetwork", deleteHighPerformanceRoutingNetworkRequest, handler, timeout || this.deleteHighPerformanceRoutingNetwork.timeout);
	};
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.listHighPerformanceRoutingNetworks = function (listHighPerformanceRoutingNetworksRequest , handler, timeout) {
		return sendRequest("listHighPerformanceRoutingNetworks", listHighPerformanceRoutingNetworksRequest, handler, timeout || this.listHighPerformanceRoutingNetworks.timeout);
	};
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.fetchHighPerformanceRoutingNetworkResponse = function (id, onResult, timeout) {
		return sendRequest("fetchHighPerformanceRoutingNetworkResponse", { id: id }, onResult, timeout || client.fetchHighPerformanceRoutingNetworkResponse.timeout);
	};
